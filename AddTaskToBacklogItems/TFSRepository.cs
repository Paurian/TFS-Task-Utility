...
//{
//    class OLD_TFSRepository // Warning CA1001  Implement IDisposable on 'TFSRepository' because it creates members of the following IDisposable types: 'TfsTeamProjectCollection'.
//    {
//        Settings settings;

//        public OLD_TFSRepository(Settings settings)
//        {
...
//        public List<int> AddTaskToEachWorkItemInCollection(WorkItemStore workItemStore, WorkItemCollection workItemCollection, Settings settings, Delegate buildTaskMethod, List<ITaskItem> tasks)
//        {
//            Project teamProject = workItemStore.Projects[settings.TfsProject];
...
//                if (tasks.Any(t => t.ID == workItem.Id))
//                {
...
//        public List<int> AddSQATaskToEachWorkItemInCollection(WorkItemStore workItemStore, WorkItemCollection workItemCollection, Settings settings, List<ITaskItem> tasks)`
//        {
